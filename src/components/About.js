      ...
      <div className="container py-5 px-5 text-center">
        <div className="text-center px-md-5">
          ...
          <p className="text-center ">
            ...
            anything else that feels right to you. <br /> I am a graduate from
            the faculty of Engineering and technology University of Buea. I
            studied software engineering. <br /> I currently work at Iknite
            space. I specialize in building web and mobile applications I also
            make things that make people happy.
          </p>
              ...
              <div class="col-md-4 wrap-service11-box">
                <div class="card card-shadow border-1 mb-4">
                  <div class="p-4">
                    ...
                    <p class="mt-3">
                      I design, build and maintain website sites, blogs and any
                      web application{" "}
                    </p>
                  </div>
                </div>
              ...
              <div class="col-md-4 wrap-service11-box">
                <div class="card card-shadow border-1 mb-4">
                  <div class="p-4">
                    ...
                    <p class="mt-3">
                      I design, build and mantain Android applications from
                      scratch to solve{" "}
                    </p>
                  </div>
                </div>
              ...
              <div class="col-md-4 wrap-service11-box">
                <div class="card card-shadow border-1 mb-4">
                  <div class="p-4">
                    ...
                    <p class="mt-3">
                      Debug and solve any computer related problem hardware or
                      software
                    </p>
                  </div>
                </div>
              ...
              <div class="col-md-4 wrap-service11-box">
                <div class="card card-shadow border-1 mb-4">
                  <div class="p-4">
                    ...
                    <p class="mt-3">
                      Professional sound engineering skills to bring out the
                      best out of any sound system
                    </p>
                  </div>
                </div>
              </div>
        ...
        <img
          ...
          src="https://www.dhsforyou.com/wp-content/uploads/2019/12/core-value1.png"
        />
      </div>
      <div className=" justify-content-center  d-flex">
        <div className="border ">
          <TbLetterE size={50} />
          <TbLetterV size={100} color="orange" />
          <TbLetterA size={50} />
        </div>
      </div>
    </div>
